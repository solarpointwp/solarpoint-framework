...
namespace SolarPoint\Core\Tests\Fixtures\Configuration;

/**
 * Fixture typed configuration object for testing configuration loading.
 *
 * @internal
 */
final class PluginConfig
{
    public function __construct(
        public readonly string $name = 'Test Plugin',
    ) {
    }
}
