...
/**
 * A concrete implementation of ServiceInterface, used as a fixture for interface binding tests.
 *
 * @internal
 */
final class ServiceImplementation implements ServiceInterface
{
}
